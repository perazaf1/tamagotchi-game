...
class FoodMenu:
    ...
    def hover(self, x, y):
        if self.box_1_rect.collidepoint((x, y)):
            text = pixel_font.render('Prix: 5 $ Effets: +3', True, (255, 255, 255))
        ...
        if self.box_2_rect.collidepoint((x, y)):
            text = pixel_font.render('Prix: 10 $ Effets: +6', True, (255, 255, 255))
        ...
        if self.box_3_rect.collidepoint((x, y)):
            text = pixel_font.render('Prix: 15 $ Effets: +10', True, (255, 255, 255))
